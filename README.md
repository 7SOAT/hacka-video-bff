<h1 align="center"> 🖥️ Hackathon - BFF Service</h1>
...
<p align="justify">
  Responsável por realizar a comunicação entre o cliente e os serviços backend.
</p>
...
<ol start="1">
  <li>
    ...
    git clone https://github.com/7SOAT/hacka-video-bff.git
    cd hacka-video-bff
  </li>
  <li>
  ...
  <li>
    ...
    <p> - Para windows:</p>
      ...
      docker build -t hacka-video-bff-latest -f devops/docker/dockerfile .

   <p> - Para Linux/macOS</p>

     sudo docker build -t hacka-video-bff-latest -f devops/docker/dockerfile .
